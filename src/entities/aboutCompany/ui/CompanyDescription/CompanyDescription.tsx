...
export function CompanyDescription() {
  const sections = [
    { id: 'history', title: 'Работаем с 2018 года', text: `Чувствительность к командам водителя, а также устойчивость автомобиля гарантируют установленные под специальным уклоном к центру тяжести автомобиля грани средних ребер и элементов грунтозацепов. Широкие борозды в форме трапеции, которые покрывают внешний слой модели, помогают шине самоочищаться. Они сгоняют воду и грязь под шину, что также помогает не впитывать лишнюю влагу.` },
    { id: 'values', title: 'Ценности компании', text: `При создании шин были применены следующие технологии:
...
«Dissymmetric drawing» — отвод воды и грязи шины достигается при помощи асимметричного рисунка протектора, что дает хорошую управляемость при маневрировании.` },
    { id: 'clients', title: 'Работаем для клиентов', text: `При создании шин были применены следующие технологии:
«3D Mode» — рисунок протектора создавался при помощи ручного 3D моделирования. Таким образом, разработчики заранее смогли увидеть все недочеты и устранить их;
«Contact with road» — широкая площадь контакта с поверхностью достигается за счет скошенным форма и рисунка протектора;
«Dissymmetric drawing» — отвод воды и грязи шины достигается при помощи асимметричного рисунка протектора, что дает хорошую управляемость при маневрировании.` }
  ];
      ...
      <div className={s.content}>
        ...
        <div id='values' className={s.section}>
          ...
          <Text className={s.text} size='md-16'>
            ...
            <br />«3D Mode» — рисунок протектора создавался при помощи ручного 3D моделирования. Таким образом, разработчики заранее смогли увидеть все недочеты и устранить их;
            <br />«Contact with road» — широкая площадь контакта с поверхностью достигается за счет скошенным форма и рисунка протектора;
            <br />«Dissymmetric drawing» — отвод воды и грязи шины достигается при помощи асимметричного рисунка протектора, что дает хорошую управляемость при маневрировании.
          </Text>
        </div>
